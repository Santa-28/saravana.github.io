...
export function Skills() {
  return (
    <Container>
      <Vector>
        <div className="js">
          <Image width={100} height={100} src="/vectors/js.svg" alt="JavaScript" loading="lazy" />
        </div>
        <div className="html">
          <Image width={85} height={85} src="/vectors/html.svg" alt="HTML" loading="lazy" />
        </div>
      </Vector>
