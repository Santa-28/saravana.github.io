...
export function Contact() {
  return (
    <Section>
      ...
      <Description>
        So if you are looking for someone hardworking, authentic and always up for a good challenge, look no further than yours truly! Let’s connect and see how we can make a difference together :)
      </Description>
      ...
      <ContainerContact>
        <ContactContent>
          <div className="contact-content">
            ...
            <Link href="https://www.linkedin.com/in/Saravanakumar28/" target="_blank">
          ...
          <div className="contact-content">
            ...
            <Link href="mailto: saravanakumarcm1212@gmail.com" target="_blank">
              <span>saravanakumarcm1212@gmail.com</span>
            </Link>
          </div>
        </ContactContent>
        <Form />
