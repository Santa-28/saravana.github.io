  ...
  return (
    <HeaderContainer style={{ position: 'fixed', top: 0, width: '100%', zIndex: 1000 }}>
      ...
      <NavMenu onClick={handleOpen} open={open}>
        ...
        <Icons>
          <Link href="https://github.com/Santa-28" target="_blank" aria-label="Link to Github">
            <FiGithub />
          </Link>
          <Link href="https://www.linkedin.com/in/Saravanakumar28/" target="_blank" aria-label="Link to Linkedin">
            <FiLinkedin />
          </Link>
          <Link href="https://www.instagram.com/x__santa__.x/" target="_blank" aria-label="Instagram">
            <FiInstagram />
          </Link>
          <Link href="https://api.whatsapp.com/send?phone=919790312318" target="_blank" aria-label="Link to contact via WhatsApp">
            <FaWhatsapp />
          </Link>
        </Icons>
      </NavMenu>
